...
|2 | [What are standalone components?](#what-are-standalone-components)|
|3 | [Difference between module-based and standalone architecture](#difference-between-module-based-and-standalone-architecture)|
|4 | [What is app.config.ts?](#what-is-appconfgts)|
|5 | [How does lazy loading work in Angular?](#how-does-lazy-loading-work-in-angular)|
|6 | [How lazy loading works with standalone components?](#how-lazy-loading-works-with-standalone-components)|
|7 | [What is dependency injection?](#what-is-dependency-injection)|
|8 | [What does @Injectable({ providedIn: 'root' }) mean?](#what-does-injectableprovidedin-root-mean)|
|9 | [What are services in Angular?](#what-are-services-in-angular)|
|10| [Why use services?](#why-use-services)|
|11| [What is Change Detection in Angular?](#what-is-change-detection-in-angular)|
|12| [What triggers change detection?](#what-triggers-change-detection)|
|13| [Default Change Detection Strategy](#default-change-detection-strategy)|
|14| [What is OnPush Change Detection?](#what-is-onpush-change-detection)|
|15| [Default vs OnPush (Clear Comparison)](#default-vs-onpush-clear-comparison)|
|16| [When Should You Use OnPush?](#when-should-you-use-onpush)|
|17| [Real-World Example: Product List](#real-world-example-product-list)|
|18| [Manually Triggering Change Detection (Advanced)](#manually-triggering-change-detection-advanced)|
|19| [What are Angular Signals?](#what-are-angular-signals)|
|20| [Why Were Signals Introduced?](#why-were-signals-introduced)|
|21| [Difference Between Signals and Observables](#difference-between-signals-and-observables)|
|22| [Can Angular Work Without Zone.js?](#can-angular-work-without-zonejs)|
|23| [How Do Signals Improve Performance?](#how-do-signals-improve-performance)|
|24| [What is @ViewChild?](#what-is-viewchild)|
|25| [How does ViewChild work?](#how-does-viewchild-work)|
|26| [What do you get from @ViewChild?](#what-do-you-get-from-viewchild)|
|27| [Difference between @ViewChild and ngModel](#difference-between-viewchild-and-ngmodel)|
|28| [Interview One-Liner Answers (Quick Recall)](#interview-one-liner-answers-quick-recall)|
|29| [When to Use What?](#when-to-use-what)|
|30| [What are Directives?](#what-are-directives)|
|31| [Types of Directives](#types-of-directives)|
|32| [What are Structural Directives?](#what-are-structural-directives)|
|33| [What are Attribute Directives?](#what-are-attribute-directives)|
|34| [What is a Custom Directive?](#what-is-a-custom-directive)|
|35| [When Should You Create a Custom Directive?](#when-should-you-create-a-custom-directive)|
|36| [What is a Pipe?](#what-is-a-pipe)|
|37| [What is a Custom Pipe?](#what-is-a-custom-pipe)|
|38| [What is the transform() method?](#what-is-the-transform-method)|
|39| [Can you use multiple pipes together?](#can-you-use-multiple-pipes-together)|
|40| [Difference between Built-in and Custom Pipes](#difference-between-built-in-and-custom-pipes)|
|41| [RxJS (Angular + JavaScript)](#rxjs-angular--javascript)|
|42| [What is RxJS?](#what-is-rxjs)|
|43| [Why Angular uses RxJS?](#why-angular-uses-rxjs)|
|44| [What is an Observable?](#what-is-an-observable)|
|45| [Difference between Observable and Promise](#difference-between-observable-and-promise)|
|46| [What is pipe() in RxJS?](#what-is-pipe-in-rxjs)|
|47| [RxJS Operators](#rxjs-operators)|
|48| [What is map operator?](#what-is-map-operator)|
|49| [What is filter operator?](#what-is-filter-operator)|
|50| [What is switchMap?](#what-is-switchmap)|
|51| [What is mergeMap?](#what-is-mergemap)|
|52| [What is concatMap?](#what-is-concatmap)|
|53| [What is forkJoin?](#what-is-forkjoin)|
|54| [Subjects](#subjects)|
|55| [What is a Subject?](#what-is-a-subject)|
|56| [What is a BehaviorSubject?](#what-is-a-behaviorsubject)|
|57| [Difference between Subject and BehaviorSubject](#difference-between-subject-and-behaviorsubject)|
|58| [When should you use Subject?](#when-should-you-use-subject)|
|59| [Authentication & Authorization (Angular)](#authentication--authorization-angular)|
|60| [What is Authentication?](#what-is-authentication)|
|61| [What is Authorization?](#what-is-authorization)|
|62| [What are Interceptors?](#what-are-interceptors)|
|63| [What is JWT?](#what-is-jwt)|
|64| [What are Route Guards?](#what-are-route-guards)|
|65| [Difference between CanActivate and CanDeactivate](#difference-between-canactivate-and-candeactivate)|
|66 | [What is Angular Framework?](#what-is-angular-framework)|
|67 | [What is the difference between AngularJS and Angular?](#what-is-the-difference-between-angularjs-and-angular)|
|68 | [What is TypeScript?](#what-is-typescript)|
|69 | [Write a pictorial diagram of Angular architecture?](#write-a-pictorial-diagram-of-angular-architecture)|
|70 | [What are the key components of Angular?](#what-are-the-key-components-of-angular)|
|71 | [What are directives?](#what-are-directives-1)|
|72 | [What are components?](#what-are-components)|
|73 | [What are the differences between Component and Directive?](#what-are-the-differences-between-component-and-directive)|
|74 | [What is a template?](#what-is-a-template)|
|75 | [What is a module?](#what-is-a-module)|
|76 | [What are lifecycle hooks available?](#what-are-lifecycle-hooks-available)|
|77 | [What is a data binding?](#what-is-a-data-binding)|
|78 | [What is metadata?](#what-is-metadata)|
|79 | [What is angular CLI?](#what-is-angular-cli)|
|80 | [What is the difference between constructor and ngOnInit?](#what-is-the-difference-between-constructor-and-ngoninit)|
|81 | [What is a service](#what-is-a-service)|
|82 | [What is dependency injection in Angular?](#what-is-dependency-injection-in-angular)|
|83 | [How is Dependency Hierarchy formed?](#how-is-dependency-hierarchy-formed)|
|84 | [What is the purpose of async pipe?](#what-is-the-purpose-of-async-pipe)|
|85 | [What is the option to choose between inline and external template file?](#what-is-the-option-to-choose-between-inline-and-external-template-file)|
|86 | [What is the purpose of *ngFor directive?](#what-is-the-purpose-of-ngfor-directive)|
|87 | [What is the purpose of ngIf directive?](#what-is-the-purpose-of-ngif-directive)|
|88 | [What happens if you use script tag inside template?](#what-happens-if-you-use-script-tag-inside-template)|
|89 | [What is interpolation?](#what-is-interpolation)|
|90 | [What are template expressions?](#what-are-template-expressions)|
|91 | [What are template statements?](#what-are-template-statements)|
|92 | [How do you categorize data binding types?](#how-do-you-categorize-data-binding-types)|
|93 | [What are pipes?](#what-are-pipes)|
|94 | [What is a parameterized pipe?](#what-is-a-parameterized-pipe)|
|95 | [How do you chain pipes?](#how-do-you-chain-pipes)|
|96 | [What is a custom pipe?](#what-is-a-custom-pipe-1)|
|97 | [Give an example of custom pipe?](#give-an-example-of-custom-pipe)|
|98 | [What is the difference between pure and impure pipe?](#what-is-the-difference-between-pure-and-impure-pipe)|
|99 | [What is a bootstrapping module?](#what-is-a-bootstrapping-module)|
|100| [What are observables?](#what-are-observables)|
|101| [What is HttpClient and its benefits?](#what-is-httpclient-and-its-benefits)|
|102| [Explain on how to use HttpClient with an example?](#explain-on-how-to-use-httpclient-with-an-example)|
|103| [How can you read full response?](#how-can-you-read-full-response)|
|104| [How do you perform Error handling?](#how-do-you-perform-error-handling)|
|105| [What is RxJS?](#what-is-rxjs-1)|
|106| [What is subscribing?](#what-is-subscribing)|
|107| [What is an observable?](#what-is-an-observable-1)|
|108| [What is an observer?](#what-is-an-observer)|
|109| [What is the difference between promise and observable?](#what-is-the-difference-between-promise-and-observable-1)|
|110| [What is multicasting?](#what-is-multicasting)|
|111| [How do you perform error handling in observables?](#how-do-you-perform-error-handling-in-observables)|
|112| [What is the shorthand notation for subscribe method?](#what-is-the-shorthand-notation-for-subscribe-method)|
|113| [What are the utility functions provided by RxJS?](#what-are-the-utility-functions-provided-by-rxjs)|
|114| [What are observable creation functions?](#what-are-observable-creation-functions)|
|115| [What will happen if you do not supply handler for the observer?](#what-will-happen-if-you-do-not-supply-handler-for-the-observer)|
|116| [What are Angular elements?](#what-are-angular-elements)|
|117| [What is the browser support of Angular Elements?](#what-is-the-browser-support-of-angular-elements)|
|118| [What are custom elements?](#what-are-custom-elements)|
|119| [Do I need to bootstrap custom elements?](#do-i-need-to-bootstrap-custom-elements)|
|120| [Explain how custom elements works internally?](#explain-how-custom-elements-works-internally)|
|121| [How to transfer components to custom elements?](#how-to-transfer-components-to-custom-elements)|
|122| [What are the mapping rules between Angular component and custom element?](#what-are-the-mapping-rules-between-angular-component-and-custom-element)|
|123| [How do you define typings for custom elements?](#how-do-you-define-typings-for-custom-elements)|
|124| [What are dynamic components?](#what-are-dynamic-components)|
|125| [What are the various kinds of directives?](#what-are-the-various-kinds-of-directives-1)|
|126| [How do you create directives using CLI?](#how-do-you-create-directives-using-cli)|
|127| [Give an example for attribute directives?](#give-an-example-for-attribute-directives)|
|128| [What is Angular Router?](#what-is-angular-router)|
|129| [What is the purpose of base href tag?](#what-is-the-purpose-of-base-href-tag)|
|130| [What are the router imports?](#what-are-the-router-imports)|
|131| [What is router outlet?](#what-is-router-outlet)|
|132| [What are router links?](#what-are-router-links)|
|133| [What are active router links?](#what-are-active-router-links)|
|134| [What is router state?](#what-is-router-state)|
|135| [What are router events?](#what-are-router-events)|
|136| [What is activated route?](#what-is-activated-route)|
|137| [How do you define routes?](#how-do-you-define-routes)|
|138| [What is the purpose of Wildcard route?](#what-is-the-purpose-of-wildcard-route)|
|139| [Do I need a Routing Module always?](#do-i-need-a-routing-module-always)|
|140| [What is Angular Universal?](#what-is-angular-universal)|
|141| [What are different types of compilation in Angular?](#what-are-different-types-of-compilation-in-angular)|
|142| [What is JIT?](#what-is-jit)|
|143| [What is AOT?](#what-is-aot)|
|144| [Why do we need compilation process?](#why-do-we-need-compilation-process)|
|145| [What are the advantages with AOT?](#what-are-the-advantages-with-aot)|
|146| [What are the ways to control AOT compilation?](#what-are-the-ways-to-control-aot-compilation)|
|147| [What are the restrictions of metadata?](#what-are-the-restrictions-of-metadata)|
|148| [What are the three phases of AOT?](#what-are-the-three-phases-of-aot)|
|149| [Can I use arrow functions in AOT?](#can-i-use-arrow-functions-in-aot)|
|150| [What is the purpose of metadata json files?](#what-is-the-purpose-of-metadata-json-files)|
|151| [Can I use any javascript feature for expression syntax in AOT?](#can-i-use-any-javascript-feature-for-expression-syntax-in-aot)|
|152| [What is folding?](#what-is-folding)|
|153| [What are macros?](#what-are-macros)|
|154| [Give an example of few metadata errors?](#give-an-example-of-few-metadata-errors)|
|155| [What is metadata rewriting?](#what-is-metadata-rewriting)|
|156| [How do you provide configuration inheritance?](#how-do-you-provide-configuration-inheritance)|
|157| [How do you specify angular template compiler options?](#how-do-you-specify-angular-template-compiler-options)|
|158| [How do you enable binding expression validation?](#how-do-you-enable-binding-expression-validation)|
|159| [What is the purpose of any type cast function?](#what-is-the-purpose-of-any-type-cast-function)|
|160| [What is Non null type assertion operator?](#what-is-non-null-type-assertion-operator)|
|161| [What is type narrowing?](#what-is-type-narrowing)|
|162| [How do you describe various dependencies in angular application?](#how-do-you-describe-various-dependencies-in-angular-application)|
|163| [What is zone?](#what-is-zone)|
|164| [What is the purpose of common module?](#what-is-the-purpose-of-common-module)|
|165| [What is codelyzer?](#what-is-codelyzer)|
|166| [What is angular animation?](#what-is-angular-animation)|
|167| [What are the steps to use animation module?](#what-are-the-steps-to-use-animation-module)|
|168| [What is State function?](#what-is-state-function)|
|169| [What is Style function?](#what-is-style-function)|
|170| [What is the purpose of animate function?](#what-is-the-purpose-of-animate-function)|
|171| [What is transition function?](#what-is-transition-function)|
|172| [How to inject the dynamic script in angular?](#how-to-inject-the-dynamic-script-in-angular)|
|173| [What is a service worker and its role in Angular?](#what-is-a-service-worker-and-its-role-in-angular)|
|174| [What are the design goals of service workers?](#what-are-the-design-goals-of-service-workers)|
|175| [What are the differences between AngularJS and Angular with respect to dependency injection?](#what-are-the-differences-between-angularjs-and-angular-with-respect-to-dependency-injection)|
|176| [What is Angular Ivy?](#what-is-angular-ivy)|
|177| [What are the features included in ivy preview?](#what-are-the-features-included-in-ivy-preview)|
|178| [Can I use AOT compilation with Ivy?](#can-i-use-aot-compilation-with-ivy)|
|179| [What is Angular Language Service?](#what-is-angular-language-service)|
|180| [How do you install angular language service in the project?](#how-do-you-install-angular-language-service-in-the-project)|
|181| [Is there any editor support for Angular Language Service?](#is-there-any-editor-support-for-angular-language-service)|
|182| [Explain the features provided by Angular Language Service?](#explain-the-features-provided-by-angular-language-service)|
|183| [How do you add web workers in your application?](#how-do-you-add-web-workers-in-your-application)|
|184| [What are the limitations with web workers?](#what-are-the-limitations-with-web-workers)|
|185| [What is Angular CLI Builder?](#what-is-angular-cli-builder)|
|186| [What is a builder?](#what-is-a-builder)|
|187| [How do you invoke a builder?](#how-do-you-invoke-a-builder)|
|188| [How do you create app shell in Angular?](#how-do-you-create-app-shell-in-angular)|
|189| [What are the case types in Angular?](#what-are-the-case-types-in-angular)|
|190| [What are the class decorators in Angular?](#what-are-the-class-decorators-in-angular)|
|191| [What are class field decorators?](#what-are-class-field-decorators)|
|192| [What is declarable in Angular?](#what-is-declarable-in-angular)|
|193| [What are the restrictions on declarable classes?](#what-are-the-restrictions-on-declarable-classes)|
|194| [What is a DI token?](#what-is-a-di-token)|
|195| [What is Angular DSL?](#what-is-angular-dsl)|
|196| [What is an rxjs Subject?](#what-is-an-rxjs-subject)|
|197| [What is Bazel tool?](#what-is-bazel-tool)|
|198| [What are the advantages of Bazel tool?](#what-are-the-advantages-of-bazel-tool)|
|199| [How do you use Bazel with Angular CLI?](#how-do-you-use-bazel-with-angular-cli)|
|200| [How do you run Bazel directly?](#how-do-you-run-bazel-directly)|
|201| [What is platform in Angular?](#what-is-platform-in-angular)|
|202| [What happens if I import the same module twice?](#what-happens-if-i-import-the-same-module-twice)|
|203| [How do you select an element with in a component template?](#how-do-you-select-an-element-with-in-a-component-template)|
|204| [How do you detect route change in Angular?](#how-do-you-detect-route-change-in-angular)|
|205| [How do you pass headers for HTTP client?](#how-do-you-pass-headers-for-http-client)|
|206| [What is the purpose of differential loading in CLI?](#what-is-the-purpose-of-differential-loading-in-cli)|
|207| [Does Angular support dynamic imports?](#does-angular-support-dynamic-imports)|
|208| [What is lazy loading?](#what-is-lazy-loading)|
|209| [What are workspace APIs?](#what-are-workspace-apis)|
|210| [How do you upgrade angular version?](#how-do-you-upgrade-angular-version)|
|211| [What is Angular Material?](#what-is-angular-material)|
|212| [How do you upgrade location service of angularjs?](#how-do-you-upgrade-location-service-of-angularjs)|
|213| [What is NgUpgrade?](#what-is-ngupgrade)|
|214| [How do you test Angular application using CLI?](#how-do-you-test-angular-application-using-cli)|
|215| [How to use polyfills in Angular application?](#how-to-use-polyfills-in-angular-application)|
|216| [What are the ways to trigger change detection in Angular?](#what-are-the-ways-to-trigger-change-detection-in-angular)|
|217| [What are the differences of various versions of Angular?](#what-are-the-differences-of-various-versions-of-angular)|
|218| [What are the security principles in angular?](#what-are-the-security-principles-in-angular)|
|219| [What is the reason to deprecate Web Tracing Framework?](#what-is-the-reason-to-deprecate-web-tracing-framework)|
|220| [What is the reason to deprecate web worker packages?](#what-is-the-reason-to-deprecate-web-worker-packages)|
|221| [How do you find angular CLI version?](#how-do-you-find-angular-cli-version)|
|222| [What is the browser support for Angular?](#what-is-the-browser-support-for-angular)|
|223| [What is schematic](#what-is-schematic)|
|224| [What is rule in Schematics?](#what-is-rule-in-schematics)|
|225| [What is Schematics CLI?](#what-is-schematics-cli)|
|226| [What are the best practices for security in angular?](#what-are-the-best-practices-for-security-in-angular)|
|227| [What is Angular security model for preventing XSS attacks?](#what-is-angular-security-model-for-preventing-xss-attacks)|
|228| [What is the role of template compiler for prevention of XSS attacks?](#what-is-the-role-of-template-compiler-for-prevention-of-xss-attacks)|
|229| [What are the various security contexts in Angular?](#what-are-the-various-security-contexts-in-angular)|
|230| [What is Sanitization? Does Angular support it?](#what-is-sanitization-does-angular-support-it)|
|231| [What is the purpose of innerHTML?](#what-is-the-purpose-of-innerhtml)|
|232| [What is the difference between interpolated content and innerHTML?](#what-is-the-difference-between-interpolated-content-and-innerhtml)|
|233| [How do you prevent automatic sanitization?](#how-do-you-prevent-automatic-sanitization)|
|234| [Is it safe to use direct DOM API methods in terms of security?](#is-it-safe-to-use-direct-dom-api-methods-in-terms-of-security)|
|235| [What is DOM sanitizer?](#what-is-dom-sanitizer)|
|236| [How do you support server side XSS protection in Angular application?](#how-do-you-support-server-side-xss-protection-in-angular-application)|
|237| [Does Angular prevent HTTP level vulnerabilities?](#does-angular-prevent-http-level-vulnerabilities)|
|238| [What are Http Interceptors?](#what-are-http-interceptors)|
|239| [What are the applications of HTTP interceptors?](#what-are-the-applications-of-http-interceptors)|
|240| [Are multiple interceptors supported in Angular?](#are-multiple-interceptors-supported-in-angular)|
|241| [How can I use interceptor for an entire application?](#how-can-i-use-interceptor-for-an-entire-application)|
|242| [How does Angular simplify Internationalization?](#how-does-angular-simplify-internationalization)|
|243| [How do you manually register locale data?](#how-do-you-manually-register-locale-data)|
|244| [What are the four phases of template translation?](#what-are-the-four-phases-of-template-translation)|
|245| [What is the purpose of i18n attribute?](#what-is-the-purpose-of-i18n-attribute)|
|246| [What is the purpose of custom id?](#what-is-the-purpose-of-custom-id)|
|247| [What happens if the custom id is not unique?](#what-happens-if-the-custom-id-is-not-unique)|
|248| [Can I translate text without creating an element?](#can-i-translate-text-without-creating-an-element)|
|249| [How can I translate attribute?](#how-can-i-translate-attribute)|
|250| [List down the pluralization categories?](#list-down-the-pluralization-categories)|
|251| [What is select ICU expression?](#what-is-select-icu-expression)|
|252| [How do you report missing translations?](#how-do-you-report-missing-translations)|
|253| [How do you provide build configuration for multiple locales?](#how-do-you-provide-build-configuration-for-multiple-locales)|
|254| [What is an angular library?](#what-is-an-angular-library)|
|255| [What is AOT compiler?](#what-is-aot-compiler)|
|256| [How do you select an element in component template?](#how-do-you-select-an-element-in-component-template)|
|257| [What is TestBed?](#what-is-testbed)|
|258| [What is protractor?](#what-is-protractor)|
|259| [What is collection?](#what-is-collection)|
|260| [How do you create schematics for libraries?](#how-do-you-create-schematics-for-libraries)|
|261| [How do you use jquery in Angular?](#how-do-you-use-jquery-in-angular)|
|262| [What is the reason for No provider for HTTP exception?](#what-is-the-reason-for-no-provider-for-http-exception)|
|263| [How can I use SASS in angular project?](#how-can-i-use-sass-in-angular-project)|
|264| [What is the purpose of hidden property?](#what-is-the-purpose-of-hidden-property)|
|265| [What is the difference between ngIf and hidden property?](#what-is-the-difference-between-ngif-and-hidden-property)|
|266| [What is slice pipe?](#what-is-slice-pipe)|
|267| [What is index property in ngFor directive?](#what-is-index-property-in-ngfor-directive)|
|268| [What is the purpose of ngFor trackBy?](#what-is-the-purpose-of-ngfor-trackby)|
|269| [What is the purpose of ngSwitch directive?](#what-is-the-purpose-of-ngswitch-directive)|
|270| [Is it possible to do aliasing for inputs and outputs?](#is-it-possible-to-do-aliasing-for-inputs-and-outputs)|
|271| [What is safe navigation operator?](#what-is-safe-navigation-operator)|
|272| [Is any special configuration required for Angular9?](#is-any-special-configuration-required-for-angular9)|
|273| [What are type safe TestBed API changes in Angular9?](#what-are-type-safe-testbed-api-changes-in-angular9)|
|274| [Is mandatory to pass static flag for ViewChild?](#is-mandatory-to-pass-static-flag-for-viewchild)|
|275| [What are the list of template expression operators?](#what-are-the-list-of-template-expression-operators)|
|276| [What is the precedence between pipe and ternary operators?](#what-is-the-precedence-between-pipe-and-ternary-operators)|
|277| [What is an entry component?](#what-is-an-entry-component)|
|278| [What is a bootstrapped component?](#what-is-a-bootstrapped-component)|
|279| [How do you manually bootstrap an application?](#how-do-you-manually-bootstrap-an-application)|
|280| [Is it necessary for bootstrapped component to be entry component?](#is-it-necessary-for-bootstrapped-component-to-be-entry-component)|
|281| [What is a routed entry component?](#what-is-a-routed-entry-component)|
|282| [Why is not necessary to use entryComponents array every time?](#why-is-not-necessary-to-use-entrycomponents-array-every-time)|
|283| [Do I still need to use entryComponents array in Angular9?](#do-i-still-need-to-use-entrycomponents-array-in-angular9)|
|284| [Is it all components generated in production build?](#is-it-all-components-generated-in-production-build)|
|285| [What is Angular compiler?](#what-is-angular-compiler)|
|286| [What is the role of ngModule metadata in compilation process?](#what-is-the-role-of-ngmodule-metadata-in-compilation-process)|
|287| [How does angular finds components, directives and pipes?](#how-does-angular-finds-components-directives-and-pipes)|
|288| [Give few examples for NgModules?](#give-few-examples-for-ngmodules)|
|289| [What are feature modules?](#what-are-feature-modules)|
|290| [What are the imported modules in CLI generated feature modules?](#what-are-the-imported-modules-in-cli-generated-feature-modules)|
|291| [What are the differences between ngmodule and javascript module?](#what-are-the-differences-between-ngmodule-and-javascript-module)|
|292| [What are the possible errors with declarations?](#what-are-the-possible-errors-with-declarations)|
|293| [What are the steps to use declaration elements?](#what-are-the-steps-to-use-declaration-elements)|
|294| [What happens if browserModule used in feature module?](#what-happens-if-browsermodule-used-in-feature-module)|
|295| [What are the types of feature modules?](#what-are-the-types-of-feature-modules)|
|296| [What is a provider?](#what-is-a-provider)|
|297| [What is the recommendation for provider scope?](#what-is-the-recommendation-for-provider-scope)|
|298| [How do you restrict provider scope to a module?](#how-do-you-restrict-provider-scope-to-a-module)|
|299| [How do you provide a singleton service?](#how-do-you-provide-a-singleton-service)|
|300| [What are the different ways to remove duplicate service registration?](#what-are-the-different-ways-to-remove-duplicate-service-registration)|
|301| [How does forRoot method helpful to avoid duplicate router instances?](#how-does-forroot-method-helpful-to-avoid-duplicate-router-instances)|
|302| [What is a shared module?](#what-is-a-shared-module)|
|303| [Can I share services using modules?](#can-i-share-services-using-modules)|
|304| [How do you get current direction for locales?](#how-do-you-get-current-direction-for-locales)|
|305| [What is ngcc?](#what-is-ngcc)|
|306| [What classes should not be added to declarations?](#what-classes-should-not-be-added-to-declarations)|
|307| [What is NgZone?](#what-is-ngzone)|
|308| [What is NoopZone?](#what-is-noopzone)|
|309| [How do you create displayBlock components?](#how-do-you-create-displayblock-components)|
|310| [What are the possible data update scenarios for change detection?](#what-are-the-possible-data-update-scenarios-for-change-detection)|
|311| [What is a zone context?](#what-is-a-zone-context)|
|312| [What are the lifecycle hooks of a zone?](#what-are-the-lifecycle-hooks-of-a-zone)|
|313| [What are the methods of NgZone used to control change detection?](#what-are-the-methods-of-ngzone-used-to-control-change-detection)|
|314| [How do you change the settings of zonejs?](#how-do-you-change-the-settings-of-zonejs)|
|315| [How do you trigger an animation?](#how-do-you-trigger-an-animation)|
|316| [How do you configure injectors with providers at different levels?](#how-do-you-configure-injectors-with-providers-at-different-levels)|
|317| [Is it mandatory to use injectable on every service class?](#is-it-mandatory-to-use-injectable-on-every-service-class)|
|318| [What is an optional dependency?](#what-is-an-optional-dependency)|
|319| [What are the types of injector hierarchies?](#what-are-the-types-of-injector-hierarchies)|
|320| [What are reactive forms?](#what-are-reactive-forms)|
|321| [What are dynamic forms?](#what-are-dynamic-forms)|
|322| [What are template driven forms?](#what-are-template-driven-forms)|
|323| [What are the differences between reactive forms and template driven forms?](#what-are-the-differences-between-reactive-forms-and-template-driven-forms)|
|324| [What are the different ways to group form controls?](#what-are-the-different-ways-to-group-form-controls)|
|325| [How do you update specific properties of a form model?](#how-do-you-update-specific-properties-of-a-form-model)|
|326| [What is the purpose of FormBuilder?](#what-is-the-purpose-of-formbuilder)|
|327| [How do you verify the model changes in forms?](#how-do-you-verify-the-model-changes-in-forms)|
|328| [What are the state CSS classes provided by ngModel?](#what-are-the-state-css-classes-provided-by-ngmodel)|
|329| [How do you reset the form?](#how-do-you-reset-the-form)|
|330| [What are the types of validator functions?](#what-are-the-types-of-validator-functions)|
|331| [Can you give an example of built-in validators?](#can-you-give-an-example-of-built-in-validators)|
|332| [How do you optimize the performance of async validators?](#how-do-you-optimize-the-performance-of-async-validators)|
|333| [How to set ngFor and ngIf on the same element?](#how-to-set-ngfor-and-ngif-on-the-same-element)|
|334| [What is host property in css?](#what-is-host-property-in-css)|
|335| [How do you get the current route?](#how-do-you-get-the-current-route)|
|336| [What is Component Test Harnesses?](#what-is-component-test-harnesses)|
|337| [What is the benefit of Automatic Inlining of Fonts?](#what-is-the-benefit-of-automatic-inlining-of-fonts)|
|338| [What is content projection?](#what-is-content-projection)|
|339| [What is ng-content and its purpose?](#what-is-ng-content-and-its-purpose)|
|340| [What is standalone component?](#what-is-standalone-component)|
|341| [How to create a standalone component uing CLI command?](#how-to-create-a-standalone-component-uing-cli-command)|
|342| [How to create a standalone component manually?](#how-to-create-a-standalone-component-manually)|
|343| [What is hydration ?](#what-is-hydration)|
|344| [What are Angular Signals?](#what-are-angular-signals)|
|345| [Explain Angular Signals with an example](#explain-angular-signals-with-an-example)|
|346| [What are the Route Parameters? Could you explain each of them?](#what-are-the-route-parameters-could-you-explain-each-of-them)|
|347| [What is NgRx?](#what-is-ngrx)|
